...
namespace WebService.Logic
{
     partial class HandlePlayerMsg
     {
        ...
        public void MsgGetRoomInfo(Player player, ProtocolBase protoBase)
        {
            ...
            {
                WbeService .instance .WriteLine("MsgGetRoomInfo status err " + player.id);
                return;
            }
        ...
        public void MsgMessage(Player player, ProtocolBase protoBase)
        {
            ...
            ProtocolBytes protocol = (ProtocolBytes)protoBase;
            string protoName = protocol.GetString(start, ref start);
            string mes = protocol.GetString(start, ref start);
            WbeService.instance.WriteLine(mes);
            Room room = player.tempData.room;
            if (room != null)
